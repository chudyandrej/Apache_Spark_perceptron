...
class BinaryPerceptronTest2 extends FlatSpec with Matchers {
  Logger.getLogger("org").setLevel(Level.ERROR)
  "A Perceptron" should "train the data with very big accuracy" in {
    ...
    val data_csv = sparkSession.read
      ...
      .option("header", "false")
      .load("./src/universal/binary/rawstockdata_binary.csv")
